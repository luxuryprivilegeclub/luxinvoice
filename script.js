// Set today's date as default
        ...
        function updatePreview() {
            ...
            document.getElementById('previewFromCity').textContent = 
                document.getElementById('fromCity').value + ', ' + document.getElementById('fromZip').value;
            ...
            document.getElementById('previewToCity').textContent = 
                document.getElementById('toCity').value + ', ' + document.getElementById('toZip').value;
